...
def get_sta(stimulation:dict, spike_movie_time:float)->np.ndarray:
    """
    ...
    if frame_idx >= total_frames or frame_idx<STA_DELAY-1:
        return None
    
    # STA Calculation
    delay_frames = []
    for n in range(STA_DELAY):
